<template>
  <div class="home-page">
    ...
    <!-- E_MenusTable -->
    <!-- s_specialArea -->
    <div class="specialArea hidden">
      <div class="assemble">
        <img
          src="http://v4.admin.crmeb.net/uploads/attach/2020/12/20201212/24409bcfe235cffece12fe7f3025f544.jpg"
          alt=""
        />
        <div class="text">
          <p class="name">一起来拼团</p>
          <p class="infor">优惠多多</p>
        </div>
      </div>
      <div class="list">
        <div class="item">
          <img
            src="http://v4.admin.crmeb.net/uploads/attach/2020/12/20201212/647852187d763e8d56655831058b9700.jpg"
            alt=""
          />
          <div class="text">
            <p class="name">秒杀专区</p>
            <p class="infor">限时秒杀错过不再</p>
          </div>
        </div>
        <div class="item">
          <img
        ...
        <div class="item" v-for="item in best" :key="item.id">
          ...
          >
            <template #tags>
              ...
              <van-tag plain type="danger" class="mr5">优惠</van-tag>
            </template>
            <template #footer>
            ...
            <template #bottom>
              <span class="sellNum ml5">已售200件</span>
            </template>
          </van-card>
        </div>
      </div>
  ...
  data() {
    return {
      ...
      hotlist: [
        {
          imgUrl:
            'http://img.alicdn.com/imgextra/i2/446338500/O1CN01C1gPMf2Cf3B2m9MvK-446338500.jpg',
          title: '阿迪达斯官网 Pro Bounce 2019Low BATW男子场上篮球运动鞋EG1536',
          price: 400.0,
        },
        {
          imgUrl:
